...
const form = useForm({
    pegawai_id: props.suamiIstriDetail.pegawai_id,
    nama: props.suamiIstriDetail.nama,
    nik: props.suamiIstriDetail.nik,
    tempat_lahir: props.suamiIstriDetail.tempat_lahir,
    tanggal_lahir: props.suamiIstriDetail.tanggal_lahir,
    tanggal_kawin: props.suamiIstriDetail.tanggal_kawin,
    no_kartu: props.suamiIstriDetail.no_kartu,
    is_pns: props.suamiIstriDetail.is_pns,
    pendidikan_id: props.suamiIstriDetail.pendidikan_id,
    pekerjaan: props.suamiIstriDetail.pekerjaan,
    status_tunjangan: props.suamiIstriDetail.status_tunjangan,
    no_sk_cerai: props.suamiIstriDetail.no_sk_cerai,
    tmt_sk_cerai: props.suamiIstriDetail.tmt_sk_cerai,
    jenis_kawin_id: props.suamiIstriDetail.jenis_kawin_id,
    no_buku_nikah: props.suamiIstriDetail.no_buku_nikah,
    media_foto_pasangan: "",
    media_buku_nikah: "",
});
...
const saveSuamiIstri = () => {
    form.transform((data) => ({ ...data, _method: "put" })).post(
        route("suami-istri.update", props.suamiIstriDetail.id),
        {
            onSuccess: (response) => {
                Swal.fire({
                    title: "Tersimpan!",
